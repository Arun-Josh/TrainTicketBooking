...
SELECT  BOOKINGS.USERID, PASSENGERINFO.PASSENGERID, 
        ...
        WHERE BOOKINGS.USERID = 2 ORDER BY PASSENGERINFO.passengerid DESC limit 0,10
...
SELECT FROMSN.STATIONID AS FROMSTATIONID, TOSN.STATIONID AS TOSTATIONID FROM STATIONNAMES FROMSN, STATIONNAMES TOSN WHERE FROMSN.STATIONNAME = "TRICHY" AND TOSN.STATIONNAME = "MADURAI";

SELECT LEAST(FROMSA.SEATSAVAILABLE, TOSA.SEATSAVAILABLE) AS SA
FROM 
SEATSAVAILABLE FROMSA, SEATSAVAILABLE TOSA 
WHERE 
FROMSA.TRAINID = 1 AND FROMSA.STATIONID = "MDU" AND FROMSA.SEATTYPE = "SLEEPER" AND FROMSA.DAY = "2019-06-29" AND
TOSA.TRAINID = 1 AND TOSA.STATIONID = "MS" AND TOSA.SEATTYPE = "SLEEPER" AND TOSA.DAY = "2019-06-29";

SELECT TRAINNAMES.TRAINNAME, TRAINNAMES.TRAINNUMBER,
       FROMSN.STATIONARRTIME AS FROMSNARRTIME, TOSN.STATIONARRTIME AS TOSNARRTIME
       FROM 
       TRAINNAMES 
       INNER JOIN 
       STATIONS FROMSN ON TRAINNAMES.TRAINID = FROMSN.TRAINID AND FROMSN.STATIONID = "MDU" AND TRAINNAMES.TRAINID = 4
       INNER JOIN
       STATIONS TOSN  ON TRAINNAMES.TRAINID = TOSN.TRAINID AND TOSN.STATIONID = "MS" AND TRAINNAMES.TRAINID = 4;

INSERT INTO USERS(MAILID, NAME, PHONE, GENDER, PASSWORD) VALUES('mailpass@123.com', 'Tester2',9876543210,"MALE", 'ec8bacb7ea0f7193e067cffd720172504ec3a0ebb50db804c99efa2c3c2dd10d3e31413e392048f1d069580ec8f0af82481775524220357901f82a725933c0ea' );
